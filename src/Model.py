...
from src import BaseModel, utils, Helpers
...
class Model(BaseModel):
    ...
    def _build_encoder(self):
        ...
        with tf.variable_scope("encoder") as encoder_scope:
            ...
            if self.hparams.encode_type == "uni":
                utils.print_out("  num_layers = %d, num_residual_layers=%d" %
                               (self.hparams.num_layers, self.hparams.num_residual_layers))
                cell = self._build_encoder_cell(
                    self.hparams.hparams, self.hparams.num_layers, self.hparams.num_residual_layers)
            ...
            elif self.hparams.encode_type == "bi":
    ...
    def _build_bi_rnn(self,inputs,sequence_length,dtype,num_bi_layers, num_bi_residual_layers,base_gpu=0):
        ...
        backward_cell = self._build_decoder_celll(num_bi_layers,num_bi_residual_layers,base_gpu=(base_gpu + num_bi_layers))
    ...
    def _build_decoder_celll(self,encoder_outputs,encoder_state, sequence_length):
        ...
        cell = Helpers.create_rnn_cell(
            ...
            fotget_biad=self.hparams.forget_bias,
